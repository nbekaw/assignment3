...
public class Main {
    public static void main(String[] args) {
        ...
        Connection conn=datab.db("db","postgres","02670267");
        ...
        while (true){
            ...
            if (action == 1){ //just gives information about current user
                ...
                if (currentUser instanceof Admin){
                    ...
                    System.out.println("All SaBoNa bank users: " + Admin.getAllUsernames());
                }
                else {
                ...
                if (currentUser instanceof Admin){
                    System.out.println("Enter the username of an user you want to delete: ");
                    String usrname = stringg.nextLine();
                    Admin.deleteUser(usrname);
                    System.out.println(usrname + " was successfully deleted");
                }
                else {
                    System.out.println("You do not have enough permissions for this!");
                }
